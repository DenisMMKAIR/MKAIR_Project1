...
public static class DummyDavlenie1Data
{
    public static DavlenieForm DavlenieData2Eta()
    {
        ...
        return new DavlenieForm
        {
            ...
            {
                [VerificationMethodCheckups.внешний_осмотр] = "6.1",
                [VerificationMethodCheckups.гермет_сист] = "6.2",
                [VerificationMethodCheckups.опробование] = "6.3",
                [VerificationMethodCheckups.электр_прочн_и_сопр_изоляции] = "6.4-6.5",
                [VerificationMethodCheckups.осн_привед_погр_и_вариации] = "6.6-6.7",
            },
            MeasurementUnit = "МПа",
