...
namespace ProjApp.Database.Maintenance.Migrations
{
    ...
    [Migration("20250701054453_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjApp.Database.Entities.VerificationMethodAlias", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_verification_method_alias");

                    b.ToTable("verification_method_alias", (string)null);
                });

            modelBuilder.Entity("ProtocolVerificationMethod", b =>
                {
                    b.Property<Guid>("ProtocolsId")
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("ProtocolsId", "VerificationMethodsId")
                        .HasName("pk_protocol_verification_method");

                    b.HasIndex("VerificationMethodsId")
                        .HasDatabaseName("ix_protocol_verification_method_verification_methods_id");

                    b.ToTable("protocol_verification_method", (string)null);
                });

            modelBuilder.Entity("VerificationMethodVerificationMethodAlias", b =>
                {
                    b.Property<Guid>("AliasesId")
                        .HasColumnType("uuid")
                        .HasColumnName("aliases_id");

                    b.Property<Guid>("VerificationMethodsId")
                        .HasColumnType("uuid")
                        .HasColumnName("verification_methods_id");

                    b.HasKey("AliasesId", "VerificationMethodsId")
                        .HasName("pk_verification_method_verification_method_alias");

                    b.HasIndex("VerificationMethodsId")
                        .HasDatabaseName("ix_verification_method_verification_method_alias_verification_");

                    b.ToTable("verification_method_verification_method_alias", (string)null);
                });
            ...
            modelBuilder.Entity("ProtocolVerificationMethod", b =>
                {
                    b.HasOne("ProjApp.Database.Entities.Protocol", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_protocol_verification_method_protocols_protocols_id");
                    ...
                    b.HasOne("ProjApp.Database.Entities.VerificationMethod", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_protocol_verification_method_verification_methods_verificat");
                });

            modelBuilder.Entity("VerificationMethodVerificationMethodAlias", b =>
                {
                    b.HasOne("ProjApp.Database.Entities.VerificationMethodAlias", null)
                        .WithMany()
                        .HasForeignKey("AliasesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_verification_method_verification_method_alias_verification_");
                    ...
                    b.HasOne("ProjApp.Database.Entities.VerificationMethod", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_verification_method_verification_method_alias_verification_1");
                });
